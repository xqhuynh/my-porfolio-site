...
function ExperienceCardSix() {
  return (
    <>
      {/* Abra Autobody */}
      <div className="rt-side-experience">
        <div>
          <p className="dates">January 2018 - September 2018</p>
        </div>
        <div className="experience-rt">
          <p>
            <strong>Abra Autobody</strong> / Customer Service Manager
          </p>
...
export default ExperienceCardSix;
